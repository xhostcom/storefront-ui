    ...
    <div className="sf-options">
      ...
      <div className="sf-options__wrapper">
        {options.map((option, idx) => <div
          key={idx}
          className="sf-options__option-container"
        ...
        >
          ...
          >{option.text}</div>}
          {isTypeColor() && <div className="sf-options__option-color-wrapper">
            <div
              className={classnames({
          ...
          {isTypeImage() && <div className="sf-options__option-image-wrapper">
            <div
              className={classnames({
