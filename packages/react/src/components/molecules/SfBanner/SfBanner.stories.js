...
storiesOf("Molecules|Banner", module)
  ...
  .add(
    ...
    () => <SfBanner classname={classnames(
      ...
      description={text("description (prop)", "The collection features formal and casual comfort shoes with a Danish design focus. Made from premium leathers and comfort.")}
  ...
  .add(
    "Custom Button",
    () => <SfBanner
      description={<b>Description property filled with some random text just to show how long it can be. Then some additional text because why not.</b>}
      subtitle="Subtitle prop"
      buttonText="Button Text"
      background="#e1e3e2"
      image="assets/storybook/Banner1.jpg"
