...
export const SfBanner = ({ classname, title, subtitle, description, background, buttonText, image, on, customButton }) => {
  return (
    <section className={classnames("sf-banner", classname)} style={{backgroundImage: `url('${image}')`, backgroundColor: `'${background}'`}}>
      <div className="sf-banner__container">
        ...
        {!customButton && <SfButton classname="sf-banner__call-to-action color-secondary" on={on}>{buttonText}</SfButton>}
