...
export const SfSearchBar = ({ classname, placeholder, value, icon, clearIcon, onInputChange}) => {
  ...
  return (
    <div className={classnames("sf-search-bar", classname)}>
      ...
      />
      {icon && <svg className="sf-search-bar__icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
