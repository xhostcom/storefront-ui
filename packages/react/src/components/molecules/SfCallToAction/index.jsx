...
export const SfCallToAction = ({ classname, title, description, background, buttonText, image, on, customButton }) => {
  return (
    <section className={classnames("sf-call-to-action", classname)} style={{backgroundImage: `url('${image}')`, backgroundColor: `'${background}'`}}>
      ...
      {!customButton && <SfButton classname="sf-call-to-action__button" on={on}>{buttonText}</SfButton>}
