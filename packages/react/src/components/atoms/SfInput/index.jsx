...
export const SfInput = ({ classname, valid, label, errorMessage, name, id, required, disabled, value, on, ...restProps }) => {

  return (
    <div className={classnames("sf-input", classname, classnames({
      ...
      <div style={{position: 'relative'}}>
        ...
        {label && <label className="sf-input__label" htmlFor={name}>
          {label}
        </label>}
      </div>
      {valid !== undefined && <div className="sf-input__error-message">
